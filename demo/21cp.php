...
//    'log_show' => true,
    ...
    'content_url_regexes' => array(
        "http://info.21cp.com/industry.*/201\d+/\d+.htm",
    ),
    'max_try' => 5,
    //'export' => array(
        //'type' => 'csv',
    ...
    'fields' => array(
        array(
            'name' => "article_title",
            'selector' => "/html/body/div[6]/div[2]/div[1]/h2",
            'required' => true,
        ),
        array(
            'name' => "article_author",
            'selector' => "/html/body/div[6]/div[2]/div[1]/ul/li[2]",
            'required' => true,
        ),
        array(
            'name' => "article_content",
            'selector' => "/html/body/div[6]/div[2]/div[3]",
            'required' => true,
        ),
        array(
            'name' => "article_publish_time",
            'selector' => "/html/body/div[6]/div[2]/div[1]/ul/li[1]",
            'required' => true,
        ),
        array(
            'name' => "url",
            'selector' => "",   // 这里随便设置，on_extract_field回调里面会替换
            'required' => true,
        ),
    ),
);
